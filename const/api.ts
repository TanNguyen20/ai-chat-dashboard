export const BASE_URL = {
  ...
  CRAWL_SERVICE: process.env.NEXT_PUBLIC_CRAWL_SERVICE_BASE_URL || "http://localhost:8089",
  CRAWLED_DATA_SERVICE: process.env.NEXT_PUBLIC_CRAWLED_DATA_SERVICE_BASE_URL || "http://localhost:8080/api/v1",
}
